...
const file_persist_proto_rawDesc = "" +
	...
	"\n" +
	"tx_packets\x18\x04 \x01(\x03R\ttxPackets*Y\n" +
	"\n" +
	"StreamType\x12\x1b\n" +
	"\x17STREAM_TYPE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12STREAM_TYPE_STDOUT\x10\x01\x12\x16\n" +
	"\x12STREAM_TYPE_STDERR\x10\x022\xa9\x01\n" +
	"\x0ePersistService\x12H\n" +
	"\tQueryLogs\x12 .joblet.persist.QueryLogsRequest\x1a\x17.joblet.persist.LogLine0\x01\x12M\n" +
	"\fQueryMetrics\x12#.joblet.persist.QueryMetricsRequest\x1a\x16.joblet.persist.Metric0\x01B/Z-github.com/ehsaniara/joblet-proto/gen/persistb\x06proto3"
...
var file_persist_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_persist_proto_depIdxs = []int32{
	...
	3, // 7: joblet.persist.PersistService.QueryLogs:output_type -> joblet.persist.LogLine
	4, // 8: joblet.persist.PersistService.QueryMetrics:output_type -> joblet.persist.Metric
